"""
    ...
    ~/github$ python3.7 -m ubt.object_detection.cvt2VOC --train_video_ids 3 --test_video_ids 1
    ...
    train 
        $python3.7 -m tools.train -f exps/example/yolox_voc/yolox_voc_s.py -d 0 -b 16 --fp16 -c /home/alex/data/ubt/object_detection/yolox_s.pth
...
if __name__ == '__main__':
    ...
    parser.add_argument('--outdir',default='~/github/upper_bound_tracking/src/ubt/object_detection/YOLOX/datasets/multitracker')
    parser.add_argument('--database', default = '~/data/ubt/data.db')
