"""
    ...
    python3.7 -m ubt.app.app --model /home/alex/checkpoints/keypoint_tracking/Resocialization_Gruppe2_2-2020-06-09_17-50-12/trained_model.h5 --project_id 3
"""
...
#from ubt.be.db.dbconnection import get_connector
from ubt.be import video, project
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_dir', required=False, default = os.path.expanduser('~/data/ubt'))
...
def get_trackannotation_path(project_id, video_id):
    return os.path.expanduser('~/data/ubt/projects/%i/%i/trackannotation.csv' % (int(project_id), int(video_id)))
