...
base_data_dir = os.path.expanduser('~/data/ubt') #os.getenv('UBT_DATA_DIR') #
if base_data_dir is None:
    ## ask the user where to put the data dir
    print(3*'\n',10* '*','\n*\n*   The data directory is not set yet. where would you like to put the database and files? (default ~/data/ubt)')
    base_data_dir = os.path.expanduser(input("Please enter the data directory:"))
    os.environ['UBT_DATA_DIR'] = base_data_dir
