...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir',required=False,default=os.path.expanduser('~/data/ubt'),help="base data directory that contains 'data.db' and folder 'projects'")
