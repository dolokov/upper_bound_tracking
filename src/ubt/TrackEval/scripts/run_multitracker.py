...
def do_evaluate():
    ...
    parser.add_argument('--json_config', default = '~/github/upper_bound_tracking/src/ubt/TrackEval/configs/TrackingUnderOcclusion.json')
    parser.add_argument('--data_dir', default = '~/data/ubt')
...
def create_summary():
    dir_eval = '/home/alex/data/ubt/evaluation'
