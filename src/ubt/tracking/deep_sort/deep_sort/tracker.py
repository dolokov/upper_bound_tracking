...
from ubt.tracking.deep_sort.deep_sort import nn_matching
...
class DeepSORTTracker:
    ...
    def __init__(self, config): # default 0.7 ; 30; 3 ; 0.2
        default_parameters = {
            ...
            'max_age': 30, 
            'n_init': 3,
            'max_cosine_distance': 0.7, # Gating threshold for cosine distance metric (object appearance).
            'nn_budget': 200 # None # Maximum size of the appearance descriptors gallery. If None, no budget is enforced.
        }
        self.config = config 
